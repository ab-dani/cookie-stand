...
const PARIhours = ['6am', '7am', '8am', '9am', '10am', '11am', '12pm', '1pm', '2pm', '3pm', '4pm', '5pm', '6pm', '7pm'];
  ...
  const Paris = {
    ...
    render: function (){
      ...
      let article = document.getElementById("cityPARI");
      
      let cityPARI = document.getElementById("h1");
      
      cityPARI.innerText = this.locationName;
      article.appendChild(cityPARI);

      let cityPARIList = document.createElement("ol")
    }
